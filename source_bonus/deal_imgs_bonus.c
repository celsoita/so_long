...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/01/11 16:29:56 by cschiavo          #+#    #+#             */
/*   Updated: 2023/01/11 16:29:58 by cschiavo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_load_sprites(t_game *g)
{
	...
	g->sprites.exit2 = ft_new_sprite(g, "textures/E2.xpm");
	g->sprites.hero1 = ft_new_sprite(g, "textures/P1.xpm");
	g->sprites.hero2 = ft_new_sprite(g, "textures/P2.xpm");
	g->sprites.enemy1 = ft_new_sprite(g, "textures/F1.xpm");
	g->sprites.enemy2 = ft_new_sprite(g, "textures/F2.xpm");
	return (0);
}
...
int	ft_free_sprites(t_game *g)
{
	...
	mlx_destroy_image(g->game.mlx, g->sprites.exit2);
	mlx_destroy_image(g->game.mlx, g->sprites.hero2);
	mlx_destroy_image(g->game.mlx, g->sprites.enemy2);
	return (0);
}
