...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/01/19 12:08:51 by cschiavo          #+#    #+#             */
/*   Updated: 2023/01/19 12:08:52 by cschiavo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_display_menu(t_menu *m, int c1, int c2)
{
	...
	mlx_put_image_to_window(m->menu.mlx, m->menu.win,
		m->img, 0, 0);
	mlx_string_put(m->menu.mlx, m->menu.win, 45, 100,
		BLACK, "SELECT MAP");
	mlx_string_put(m->menu.mlx, m->menu.win, 45, 115,
		c1, m->maps.mat[m->opt.x]);
	mlx_string_put(m->menu.mlx, m->menu.win, 45, 130, c2, "info");
	return (0);
}
